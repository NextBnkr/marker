...
# 注意：每个模型目录必须包含 manifest.json，surya 用它判断模型是否已下载。
# =============================================================================
...
FILES=(
  # text_detection
  "text_detection/2025_05_07/manifest.json"
  ...
  # text_recognition
  "text_recognition/2025_09_23/manifest.json"
  ...
  # layout
  "layout/2025_09_23/manifest.json"
  ...
  # table_recognition
  "table_recognition/2025_02_18/manifest.json"
  ...
  # ocr_error_detection
  "ocr_error_detection/2025_02_18/manifest.json"
